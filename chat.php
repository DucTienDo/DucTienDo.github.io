...
<body onpageshow="scroll()">
    ...
    <div class="container">
            ...
            <div class="content">
                ...
                foreach ($content as $i) {
                    ...
                    if (isset($chat[0]) && isset($chat[1]) && isset($chat[2])){
                        ...
                        $chat[1] = turnUrlIntoHyperlink($chat[1]);
        ...
        <form method="post">
            <textarea name="message" id="sending" cols="90" rows="5" placeholder="Enter your message..." autofocus
    ...
    <footer style="text-align: center">
        <small>Made with <span style="color:red">&#10084;</span> by Nguyen Duc Hung and Do Duc Tien.</small><br>
